    ...
    () => [
      ...
      ResizableImage.configure({
        HTMLAttributes: {
          ...
          class:
            "resizable-image max-w-full h-auto rounded-lg shadow-sm cursor-pointer",
        },
        allowBase64: true,
      }),
      Subscript,
      ...
      TableHeader.configure({
        HTMLAttributes: {
          class:
            "border border-neutral-300 bg-neutral-50 p-2 font-semibold text-left",
        },
      }),
      TableCell.configure({
        HTMLAttributes: {
            ...
            {pagePreviews.length === 0 ? (
              ...
              pagePreviews.map((html, idx) => (
                ...
                >
                  ...
                  <div className="px-2 py-1 border-t text-xs text-neutral-600 text-center">
                    Page {idx + 1}
                  </div>
                </button>
              ))
